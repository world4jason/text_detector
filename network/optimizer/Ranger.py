...
class Ranger(optimizer.Optimizer):
    def __init__(self,
        ...
        super(Ranger, self).__init__(use_locking, name)
        ...
        self._alpha = alpha
        self._k = k
        self._sma_thtrshhold = N_sma_threshhold
    ...
    def _create_slots(self, var_list):
        ...
        self._create_non_slot_variable(initial_value=0.0, name="step", colocate_with=first_var)
        ...
        for v in var_list:
            ...
            self._zeros_slot(v, "slow", self._name)
    ...
    def _prepare(self):
        ...
        k = self._call_if_callable(self._k)
        ...
        self._k_t = ops.convert_to_tensor(k, name="k")
        self._alpha_t = ops.convert_to_tensor(alpha, name="alpha")
    ...
    def _resource_apply_dense(self, grad, var):
        ...
        var_t = tf.cond(sma_t >= self._sma_thtrshhold, lambda : r_t * mhat_t / vhat_t, lambda : mhat_t)
        ...
        var_update = tf.cond(
            ...
            lambda: state_ops.assign(var_update,state_ops.assign_add(slow_weight, (var_update - slow_weight) * alpha)),
            lambda :var_update)
